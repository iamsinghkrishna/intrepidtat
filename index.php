...
<body>
   ...
   <div class="tp-offcanvas">
      <div class="tp-offcanvas-header mb-30">
         <div class="tp-offcanvas-logo">
            <a href="index.html"><img data-width="108" src="assets/img/logo/intrepid-logo.png" alt=""></a>
         </div>
      ...
      <div class="tp-offcanvas-info mb-50">
         ...
         <span><a href="#">info@intrepidtat.online</a></span>
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="tp-header-top-info">
                     <ul>
                        ...
                        <li><a href="mailto:turie@gmail.com">info@intrepidtat.online</a></li>
                     </ul>
                  </div>
               </div>
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="tp-header-top-switcher-wrap d-flex justify-content-end">
                     ...
                     <div class="tp-header-top-menu-item tp-header-top-currency ml-30">
                        <span class="tp-header-top-currency-toggle" id="tp-header-top-currency-toggle"><img src="assets/img/flag/01.png" alt=""> USD</span>
                        <ul>
                           <li>
            ...
            <div class="row align-items-center">
               <div class="col-xl-2 col-6">
                  <div class="tp-header-logo">
                     <a href="index.html">
                        <img width="112" src="assets/img/logo/intrepid-logo.png" alt="">
                     </a>
                  </div>
               </div>
               <div class="col-xl-6 d-none d-xl-block">
                  <div class="tp-main-menu tp-menu-dropdown text-end">
                     <nav class="tp-mobile-menu-active">
                        <ul>
                           <li class="has-dropdowns active">
   ...
   <main>
      ...
      <!-- tp-hero-area-start -->
      <div class="tp-hero-area tp-hero-bg bg-position z-index-2 p-relative" data-background="assets/img/hero/bg.jpeg">
         <img class="tp-hero-shape" src="assets/img/hero/shape.png" alt="">
         <div class="container">
            <div class="row align-items-center">
               <div class="col-xl-7 col-lg-6">
                  <div class="tp-hero-content  mb-30">
                     ...
                     <a href="about.html" class="tp-btn tp-btn-xxl tp-btn-white wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".6s">Get to Know Us</a>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="tp-section-title-wrap text-center mb-40">
                     <span class="tp-section-subtitle d-inline-block mb-10 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".3s">Explore Places</span>
                     <h2 class="tp-section-title fw-600 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".4s">Explore our most loved <br> destinations</h2>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-6 col-md-6">
                  <div class="tp-tour-dayfilter-item tp-destination-one-item p-relative mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".3s">
                     <div class="tp-destination-one-thumb tp-tour-dayfilter-thumb p-relative fix">
                        <img class="w-100" src="assets/img/destination/one/thumb.jpg" alt="">
                        <div class="tp-destination-one-content tp-destination-content">
                           <div class="tp-destination-one-left">
                              <h2 class="tp-destination-title common-underline mb-0"><a href="city-details-3.html">Thailand</a></h2>
                              <span class="tp-destination-one-duration">07 Tour</span>
                           </div>
                           <a href="city-details-3.html" class="tp-destination-one-btn">View All</a>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-6 col-md-6">
                  <div class="tp-tour-dayfilter-item tp-destination-one-item p-relative mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".4s">
                     <div class="tp-destination-one-thumb tp-tour-dayfilter-thumb p-relative fix">
                        <img class="w-100" src="assets/img/destination/one/thumb-2.jpg" alt="">
                        <div class="tp-destination-one-content tp-destination-content">
                           <div class="tp-destination-one-left">
                              <h2 class="tp-destination-title common-underline mb-0"><a href="city-details-3.html">North Est India</a></h2>
                              <span class="tp-destination-one-duration">16 Tour</span>
                           </div>
                           <a href="city-details-3.html" class="tp-destination-one-btn">View All</a>
                        </div>
                     </div>
               ...
               <div class="col-xl-3 col-lg-6 col-md-6">
                  <div class="tp-tour-dayfilter-item tp-destination-one-item p-relative mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".5s">
                     <div class="tp-destination-one-thumb tp-tour-dayfilter-thumb p-relative fix">
                        <img class="w-100" src="assets/img/destination/one/thumb-3.jpg" alt="">
                        <div class="tp-destination-one-content tp-destination-content">
                           <div class="tp-destination-one-left">
                              <h2 class="tp-destination-title common-underline mb-0"><a href="city-details-3.html">Canada</a></h2>
                              <span class="tp-destination-one-duration">05 Tour</span>
                           </div>
                           <a href="city-details-3.html" class="tp-destination-one-btn">View All</a>
                        </div>
                     </div>
               ...
               <div class="col-xl-3 col-lg-6 col-md-6">
                  <div class="tp-tour-dayfilter-item tp-destination-one-item p-relative mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".6s">
                     <div class="tp-destination-one-thumb tp-tour-dayfilter-thumb p-relative fix">
                        <img class="w-100" src="assets/img/destination/one/thumb-4.jpg" alt="">
                        <div class="tp-destination-one-content tp-destination-content">
                           <div class="tp-destination-one-left">
                              <h2 class="tp-destination-title common-underline mb-0"><a href="city-details-3.html">Morocco</a></h2>
                              <span class="tp-destination-one-duration">12 Tour</span>
                           </div>
                           <a href="city-details-3.html" class="tp-destination-one-btn">View All</a>
                        </div>
                     </div>
      ...
      <div class="tp-service-area pt-80 pb-40 p-relative" data-bg-color="#f7f9f9">
            ...
            <div class="row">
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="tp-service-item icon-animetion-wrap text-center mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".3s">
                     ...
                     <div class="tp-service-content">
                        <h2 class="tp-service-title fw-600">Affordable pricing</h2>
                        <p>Join unforgettable festivals concerts <br> local celebrations.</p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="tp-service-item icon-animetion-wrap text-center mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".4s">
                     ...
                     <div class="tp-service-content">
                        <h2 class="tp-service-title fw-600">Special event trips</h2>
                        <p>Join unforgettable festivals concerts <br> local celebrations.</p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="tp-service-item icon-animetion-wrap text-center mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".5s">
                     ...
                     <div class="tp-service-content">
                        <h2 class="tp-service-title fw-600">24/7 Customer support</h2>
                        <p>Join unforgettable festivals concerts <br> local celebrations.</p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="tp-service-item icon-animetion-wrap text-center mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".6s">
                     ...
                     <div class="tp-service-content">
                        <h2 class="tp-service-title fw-600">Complete Safety</h2>
                        <p>Join unforgettable festivals concerts <br> local celebrations.</p>
                     </div>
                  </div>
               </div>
      ...
      <!-- tp-about-area-start -->
      <div class="tp-about-area tp-section-pt tp-section-pb pt-140 pb-100">
         <div class="container">
            <div class="row">
               <div class="col-lg-7">
                  <div class="tp-about-content mb-40">
                     <div class="tp-about-section-title p-relative pb-105 ml-70">
                        <span class="tp-section-subtitle d-inline-block mb-20 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".3s">About Us</span>
                        <h2 class="tp-section-title fw-600 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".4s">Embark on your dream journey
                           discover hidden gems around the
                           world experience.</h2>
                        <img class="tp-about-shape d-none d-sm-block" src="assets/img/about/shape.png" alt="shape">
                     </div>
                     <div class="tp-about-left-thumb p-relative wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".5s">
                        <img class="w-100" src="assets/img/about/thumb.jpg" alt="">
                        <div class="tp-about-circale">
                           <h2 class="tp-about-circale-title text-uppercase fw-700 mb-0">10+</h2>
                           <div class="tp-about-circale-text">
                              <img class="rotate-infinite" src="assets/img/about/text.png" alt="">
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-lg-5">
                  <div class="tp-about-right-content ml-45 mb-40 mt-50 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".4s">
                     <div class="tp-about-left-thumb mb-40">
                        <img class="w-100" src="assets/img/about/thumb-2.jpg" alt="">
                     </div>
                     <p class="mb-50">We transform your travel dreams into unforgettable realities.<br>
                     From serene beaches to bustling cities our tours cover. Discover<br>
                     hidden gems immerse yourself in unique cultures.</p>
                     <div class="tp-about-help-wrap mb-190 d-flex flex-wrap align-items-center">
                        <div class="mr-15 mb-10">
                           <a href="about.html" class="tp-btn">More about us
         ...
         <div class="container">
            <div class="row align-items-end mb-20">
               ...
               <div class="col-lg-4">
                  <div class="text-lg-end mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".5s">
                     <a href="tour-grid.html" class="tp-btn-solid">
                        View All Deals
            ...
            <div class="row">
               <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                  <div class="tp-tour-item mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".2s">
                     <div class="tp-tour-thumb p-relative fix">
                        <a href="tour-details-4.html" class="image">
                     ...
                     <div class="tp-tour-content">
                        ...
                        <h3 class="tp-tour-title fw-500 mb-10"><a href="tour-details-4.html">Chiang mai mountain eco adventure tour.</a></h3>
                        ...
                        <div class="tp-tour-footer d-flex justify-content-between gap-2 align-items-center">
                           ...
                           <div class="tp-tour-btn">
                              <a href="tour-details-4.html" class="tp-btn-sm fw-500 tp-ff-inter">Book A tour</a>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                  <div class="tp-tour-item mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".3s">
                     <div class="tp-tour-thumb p-relative fix">
                        <a href="tour-details-4.html" class="image">
                     ...
                     <div class="tp-tour-content">
                        ...
                        <h3 class="tp-tour-title fw-500 mb-10"><a href="tour-details-4.html">Jungle walking tour with an  authentic cultural lunch</a></h3>
                        <div class="tp-tour-info">
                           <span>
                              <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M9.49961 7.04985C9.49961 8.40295 8.40271 9.49985 7.04961 9.49985C5.69651 9.49985 4.59961 8.40295 4.59961 7.04985C4.59961 5.69675 5.69651 4.59985 7.04961 4.59985C8.40271 4.59985 9.49961 5.69675 9.49961 7.04985Z" stroke="currentColor" stroke-width="1.5" />
               ...
               <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                  <div class="tp-tour-item mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".4s">
                     <div class="tp-tour-thumb p-relative fix">
                        <a href="tour-details-4.html" class="image">
                     ...
                     <div class="tp-tour-content">
                        ...
                        <h3 class="tp-tour-title fw-500 mb-10"><a href="tour-details-4.html">Desert adventure safari with a Sunset dinner package</a></h3>
                        <div class="tp-tour-info">
                           <span>
                              <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M9.49961 7.04985C9.49961 8.40295 8.40271 9.49985 7.04961 9.49985C5.69651 9.49985 4.59961 8.40295 4.59961 7.04985C4.59961 5.69675 5.69651 4.59985 7.04961 4.59985C8.40271 4.59985 9.49961 5.69675 9.49961 7.04985Z" stroke="currentColor" stroke-width="1.5" />
               ...
               <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                  <div class="tp-tour-item mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".5s">
                     <div class="tp-tour-thumb p-relative fix">
                        <a href="tour-details-4.html" class="image">
                     ...
                     <div class="tp-tour-content">
                        ...
                        <h3 class="tp-tour-title fw-500 mb-10"><a href="tour-details-4.html">Scenic nature journey with a delicious lunch basket</a></h3>
                        <div class="tp-tour-info">
                           <span>
                              <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M9.49961 7.04985C9.49961 8.40295 8.40271 9.49985 7.04961 9.49985C5.69651 9.49985 4.59961 8.40295 4.59961 7.04985C4.59961 5.69675 5.69651 4.59985 7.04961 4.59985C8.40271 4.59985 9.49961 5.69675 9.49961 7.04985Z" stroke="currentColor" stroke-width="1.5" />
               ...
               <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                  <div class="tp-tour-item mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".6s">
                     <div class="tp-tour-thumb p-relative fix">
                        <a href="tour-details-4.html" class="image">
                     ...
                     <div class="tp-tour-content">
                        ...
                        <h3 class="tp-tour-title fw-500 mb-10"><a href="tour-details-4.html">Bangkok urban green nice spaces walking tour.</a></h3>
                        <div class="tp-tour-info">
                           <span>
                              <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M9.49961 7.04985C9.49961 8.40295 8.40271 9.49985 7.04961 9.49985C5.69651 9.49985 4.59961 8.40295 4.59961 7.04985C4.59961 5.69675 5.69651 4.59985 7.04961 4.59985C8.40271 4.59985 9.49961 5.69675 9.49961 7.04985Z" stroke="currentColor" stroke-width="1.5" />
               ...
               <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                  <div class="tp-tour-item mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".7s">
                     <div class="tp-tour-thumb p-relative fix">
                        <a href="tour-details-4.html" class="image">
                     ...
                     <div class="tp-tour-content">
                        ...
                        <h3 class="tp-tour-title fw-500 mb-10"><a href="tour-details-4.html">Sukhothai historical sustainable cycling tour.</a></h3>
                        <div class="tp-tour-info">
                           <span>
                              <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M9.49961 7.04985C9.49961 8.40295 8.40271 9.49985 7.04961 9.49985C5.69651 9.49985 4.59961 8.40295 4.59961 7.04985C4.59961 5.69675 5.69651 4.59985 7.04961 4.59985C8.40271 4.59985 9.49961 5.69675 9.49961 7.04985Z" stroke="currentColor" stroke-width="1.5" />
               ...
               <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                  <div class="tp-tour-item mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".8s">
                     <div class="tp-tour-thumb p-relative fix">
                        <a href="tour-details-4.html" class="image">
                     ...
                     <div class="tp-tour-content">
                        ...
                        <h3 class="tp-tour-title fw-500 mb-10"><a href="tour-details-4.html">Full-Day hiking adventure with Picnic Lunch Provided</a></h3>
                        <div class="tp-tour-info">
                           <span>
                              <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M9.49961 7.04985C9.49961 8.40295 8.40271 9.49985 7.04961 9.49985C5.69651 9.49985 4.59961 8.40295 4.59961 7.04985C4.59961 5.69675 5.69651 4.59985 7.04961 4.59985C8.40271 4.59985 9.49961 5.69675 9.49961 7.04985Z" stroke="currentColor" stroke-width="1.5" />
               ...
               <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                  <div class="tp-tour-item mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".9s">
                     <div class="tp-tour-thumb p-relative fix">
                        <a href="tour-details-4.html" class="image">
                     ...
                     <div class="tp-tour-content">
                        ...
                        <h3 class="tp-tour-title fw-500 mb-10"><a href="tour-details-4.html">Sunset desert journey with a nomadic meal experience</a></h3>
                        <div class="tp-tour-info">
                           <span>
                              <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M9.49961 7.04985C9.49961 8.40295 8.40271 9.49985 7.04961 9.49985C5.69651 9.49985 4.59961 8.40295 4.59961 7.04985C4.59961 5.69675 5.69651 4.59985 7.04961 4.59985C8.40271 4.59985 9.49961 5.69675 9.49961 7.04985Z" stroke="currentColor" stroke-width="1.5" />
      ...
      <div class="tp-gallery-space fix" data-bg-color="#071516">
         <div class="container-fluid gx-0">
            <div class="row gx-25">
               <div class="col-3">
                  <div class="tp-gallery-wrap">
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb.jpg" alt="">
                     </div>
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb-2.jpg" alt="">
                     </div>
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb-3.jpg" alt="">
                     </div>
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb-2.jpg" alt="">
                     </div>
               ...
               <div class="col-3">
                  <div class="tp-gallery-wrap tp-gallery-wrap-2">
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb-4.jpg" alt="">
                     </div>
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb-5.jpg" alt="">
                     </div>
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb-6.jpg" alt="">
                     </div>
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb-5.jpg" alt="">
                     </div>
               ...
               <div class="col-3">
                  <div class="tp-gallery-wrap">
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb-7.jpg" alt="">
                     </div>
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb-8.jpg" alt="">
                     </div>
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb-9.jpg" alt="">
                     </div>
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb-8.jpg" alt="">
                     </div>
               ...
               <div class="col-3">
                  <div class="tp-gallery-wrap tp-gallery-wrap-2">
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb-10.jpg" alt="">
                     </div>
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb-11.jpg" alt="">
                     </div>
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb-12.jpg" alt="">
                     </div>
                     <div class="tp-gallery-item mb-25">
                        <img class="w-100" src="assets/img/gallery/gallery-1/thumb-11.jpg" alt="">
                     </div>
      ...
      <!-- tp-chose-area-start -->
      <div class="tp-chose-area pt-160 pb-80 tp-section-pt tp-section-pb">
         <div class="container">
            <div class="row">
               <div class="col-xl-6">
                  <div class="tp-chose-section-title p-relative mb-60">
                     <span class="tp-section-subtitle d-inline-block mb-15 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".3s">Why Choose Us</span>
                     <h2 class="tp-section-title fw-600 mb-10 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".4s">Reasons people<br> love traveling with us</h2>
                     <p class="mb-40 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".5s">We’re more than just a travel we’re trusted companion on<br> every journey and booking to local tips.</p>
                     <a href="about.html" class="tp-btn wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".6s">Learn more
                        <svg width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path d="M11.4922 5.89282H0.900117" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                           <path d="M7.1765 10.8855C7.1765 10.8855 11.884 7.20841 11.884 5.89276C11.884 4.57711 7.17642 0.900146 7.17642 0.900146" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
               ...
               <div class="col-xl-6">
                  <div class="tp-chose-wrap">
                     <div class="tp-chose-item mb-60" data-bg-color="#f7e4fe">
                        <div class="row">
                           <div class="col-md-7">
                              <div class="tp-chose-content">
                                 <h3 class="tp-chose-numbar">01</h3>
                                 <h4 class="tp-chose-title"><a href="about.html">Meet our travel experts</a></h4>
                                 <p class="tp-chose-dec mb-25">We’re more than just a travel service we’re your<br> trusted companion on every journey.</p>
                                 <a href="about.html" class="tp-btn-solid">
                                    Learn more
                                    <svg width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                           ...
                           <div class="col-md-5">
                              <div class="tp-chose-thumb ml-40">
                                 <img class="w-100" src="assets/img/chose/thumb.jpg" alt="">
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="tp-chose-item mb-60" data-bg-color="#ecf8f1">
                        <div class="row">
                           <div class="col-md-7">
                              <div class="tp-chose-content">
                           ...
                           <div class="col-md-5">
                              <div class="tp-chose-thumb ml-40">
                                 <img class="w-100" src="assets/img/chose/thumb-2.jpg" alt="">
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="tp-chose-item mb-60" data-bg-color="#fef9ce">
                        <div class="row">
                           <div class="col-md-7">
                              <div class="tp-chose-content">
                           ...
                           <div class="col-md-5">
                              <div class="tp-chose-thumb ml-40">
                                 <img class="w-100" src="assets/img/chose/thumb-3.jpg" alt="">
                              </div>
                           </div>
                        </div>
                     </div>
            ...
            <div class="row">
               ...
               <div class="col-xl-7">
                  <div class="tp-blog-item tp-blog-col-1 mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".3s">
                     ...
                     <div class="tp-blog-content">
                        ...
                        <h3 class="tp-blog-title fw-600 mb-15"><a href="blog-details.html">Experience vibrant festivals, explore the<br> amazing Amazon rainforest</a></h3>
                        <a href="blog-details.html" class="tp-btn-solid">Learn more
               ...
               <div class="col-xl-5">
                  <div class="tp-blog-item tp-blog-col-2 mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".4s">
                     <div class="tp-blog-thumb fix">
                        <a href="blog-details.html" class="d-inline-block">
                            <img src="assets/img/blog/thumb-sm.jpg" alt="">
                        </a>
                     </div>
                     <div class="tp-blog-content">
                        <div class="tp-blog-meta-wrap d-flex flex-wrap align-items-center mb-15">
                        ...
                        <h3 class="tp-blog-title fw-600 mb-15"><a href="blog-details.html">Explore ancient pyramids & desert adventures.</a></h3>
                        <a href="blog-details.html" class="tp-btn-solid">Learn more
                           <svg width="11" height="10" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M9.07141 4.67188L0.750023 4.67187" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M5.68092 8.59474C5.68092 8.59474 9.37927 5.70593 9.37927 4.67232C9.37928 3.63872 5.68086 0.75 5.68086 0.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  ...
                  <div class="tp-blog-item tp-blog-col-2 mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".5s">
                     <div class="tp-blog-thumb fix">
                        <a href="blog-details.html" class="d-inline-block">
                            <img src="assets/img/blog/thumb-sm-2.jpg" alt="">
                        </a>
                     </div>
                     <div class="tp-blog-content">
                        <div class="tp-blog-meta-wrap d-flex flex-wrap align-items-center mb-15">
                        ...
                        <h3 class="tp-blog-title fw-600 mb-15"><a href="blog-details.html">Collaboration turns ideas powerful results that</a></h3>
                        <a href="blog-details.html" class="tp-btn-solid">Learn more
                           <svg width="11" height="10" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M9.07141 4.67188L0.750023 4.67187" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M5.68092 8.59474C5.68092 8.59474 9.37927 5.70593 9.37927 4.67232C9.37928 3.63872 5.68086 0.75 5.68086 0.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  ...
                  <div class="tp-blog-item tp-blog-col-2 mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".6s">
                     <div class="tp-blog-thumb fix">
                        <a href="blog-details.html" class="d-inline-block">
                            <img src="assets/img/blog/thumb-sm-3.jpg" alt="">
                        </a>
                     </div>
                     <div class="tp-blog-content">
                        <div class="tp-blog-meta-wrap d-flex flex-wrap align-items-center mb-15">
                        ...
                        <h3 class="tp-blog-title fw-600 mb-15"><a href="blog-details.html">Great minds working together can tackle even the toughest.</a></h3>
                        <a href="blog-details.html" class="tp-btn-solid">Learn more
                           <svg width="11" height="10" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M9.07141 4.67188L0.750023 4.67187" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M5.68092 8.59474C5.68092 8.59474 9.37927 5.70593 9.37927 4.67232C9.37928 3.63872 5.68086 0.75 5.68086 0.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />

...
<body>
   ...
   <main>
            ...
            <div class="row">
               <div class="col-12">
                  <div class="tp-breadcrumb-wrap text-center">
                     <h2 class="tp-breadcrumb-title fs-112 text-center mb-10">Our products</h2>
      ...
      <div class="tp-product-ptb pt-120 pb-60">
         <div class="container container-1350">
            <div class="row">
               <div class="col-sm-6">
                  <div class="tp-shop-top-left mb-25 mt-10">
                     <p class="mb-0 tp-ff-dm">Showing 1–14 of 26 results</p>
                  </div>
               </div>
               <div class="col-sm-6">
            ...
            <div class="row">
                  ...
                  <div class="tp-product-item mb-50">
                     ...
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">Camping Tent</a>
                        </h3>
               ...
               <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="tp-product-item mb-50">
                     ...
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">Travel Neck Pillow</a>
                        </h3>
                        <div class="tp-product-price-wrapper">
               ...
               <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="tp-product-item mb-50">
                     ...
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">Minimal Utility Backpack</a>
                        </h3>
                        <div class="tp-product-price-wrapper">
               ...
               <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="tp-product-item mb-50">
                     ...
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">Travel Waist Bag</a>
                        </h3>
                        <div class="tp-product-price-wrapper">
               ...
               <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="tp-product-item mb-50">
                     <div class="tp-product-thumb mb-15 fix p-relative z-index-1">
                        ...
                        <div class="tp-product-add-cart-btn-large-wrapper">
                           <button type="button" class="tp-product-add-cart-btn-large"> Add To Cart                                           
                           </button>
                        </div>
                     </div>
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">Hard Shell Travel Suitcase</a>
                        </h3>
                        <div class="tp-product-price-wrapper">
                           <span class="tp-product-price">$60.00</span>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="tp-product-item mb-50">
                     ...
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">Wall Charger Adapter</a>
                        </h3>
                        <div class="tp-product-price-wrapper">
                           <span class="tp-product-price">$120.00</span>
                        </div>
               ...
               <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="tp-product-item mb-50">
                     ...
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">Portable Power Bank Set</a>
                        </h3>
                        <div class="tp-product-price-wrapper">
                           <span class="tp-product-price">$130.00</span>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="tp-product-item mb-50">
                     ...
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">Men’s Zip-Up Jacket</a>
                        </h3>
                        <div class="tp-product-price-wrapper">
                           <span class="tp-product-price">$260.00</span>
                        </div>
               ...
               <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="tp-product-item mb-50">
                     <div class="tp-product-thumb mb-15 fix p-relative z-index-1">
                        <a href="shop-details.html">
                           <img class="w-100" src="assets/img/product/product-9.jpg" alt="">
                        </a>
                        <!-- product action -->
                        <div class="tp-product-action tp-product-action-blackStyle">
                           <div class="tp-product-action-item d-flex flex-column">
                     ...
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">Cotton Crew Socks Set</a>
                        </h3>
                        <div class="tp-product-price-wrapper">
                           <span class="tp-product-price">$60.00</span>
                        </div>
               ...
               <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="tp-product-item mb-50">
                     <div class="tp-product-thumb mb-15 fix p-relative z-index-1">
                        <a href="shop-details.html">
                           <img class="w-100" src="assets/img/product/product-10.jpg" alt="">
                        </a>
                        <!-- product action -->
                        <div class="tp-product-action tp-product-action-blackStyle">
                           <div class="tp-product-action-item d-flex flex-column">
                     ...
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">3D Sleep Eye Mask</a>
                        </h3>
                        <div class="tp-product-price-wrapper">
                           <span class="tp-product-price">$120.00</span>
                        </div>
               ...
               <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="tp-product-item mb-50">
                     <div class="tp-product-thumb mb-15 fix p-relative z-index-1">
                        <a href="shop-details.html">
                           <img class="w-100" src="assets/img/product/product-11.jpg" alt="">
                        </a>
                        <div class="tp-product-badge">
                           <span class="product-discount on-sale">-20%</span>
                        </div>
                     ...
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">Casual Crossbody Bag</a>
                        </h3>
                        <div class="tp-product-price-wrapper">
                           <span class="tp-product-price">$130.00</span>
                        </div>
               ...
               <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="tp-product-item mb-50">
                     <div class="tp-product-thumb mb-15 fix p-relative z-index-1">
                        <a href="shop-details.html">
                           <img class="w-100" src="assets/img/product/product-12.jpg" alt="">
                        </a>
                        <div class="tp-product-badge">
                           <span class="product-discount">HOT</span>
                        </div>
                     ...
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">WiFi Router Device</a>
                        </h3>
                        <div class="tp-product-price-wrapper">
                           <span class="tp-product-price">$260.00</span>
                        </div>

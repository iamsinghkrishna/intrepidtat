...
<body>
   ...
   <main>
      ...
      <!-- Register area start -->
      <div class="tp-login-area pre-header pt-120 pb-140 p-relative z-index-1 fix">
         <div class="container container-1350">
            <div class="row justify-content-center">
               <div class="col-xl-6 col-lg-8">
                  <div class="tp-login-wrapper">
                     <div class="tp-login-top text-center mb-30">
                        <h3 class="tp-login-title">Sign up Turie.</h3>
                        <p>Don’t have an account? <span><a href="login.html">Sign In</a></span></p>
                     </div>
                     <div class="tp-login-option">
                        <form action="#">
                           ...
                           <div class="tp-login-input-wrapper tp-contact-form">
                              <div class="tp-review-input mb-20">
                                 <label class="tp-label mb-5" for="name">Name</label>
                                 <input class="tp-input" type="text" id="name" placeholder="Your Name...">
                              </div>
                              <div class="tp-review-input mb-20">
                                 <label class="tp-label mb-5" for="email">Your Email</label>
                                 <input class="tp-input" type="email" id="email" placeholder="turie@mail.com">
                              </div>
                              <div class="tp-review-input mb-20">
                                 <label class="tp-label mb-5" for="password">Password</label>
                                 <div class="p-relative">
                                    <input class="tp-input" type="password" id="password" placeholder="Min. 6 character">
                           ...
                           <div class="tp-review-input d-flex align-items-start mb-20">
                              <input class="tp-checkbox" type="checkbox" id="agree">
                              <label class="tp-agree" for="agree">I accept the terms of the Service & Privacy Policy.</label>
                           </div>
                           <div class="tp-contact-form-btn">
                              <button type="submit" class="tp-btn tp-btn-xl w-100 text-center">Sign Up</button>
                           </div>
                        </form>
                     </div>
                  </div>

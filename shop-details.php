...
<body>
      ...
      <div class="cartmini__wrapper d-flex justify-content-between flex-column">
         <div class="cartmini__top-wrapper">
            ...
            <div class="cartmini__shipping">
               ...
               <div class="progress">
                  <div class="progress-bar progress-bar-striped progress-bar-animated bg-warning" role="progressbar" data-width="70%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
               </div>
            </div>
            <div class="cartmini__widget">
               <div class="cartmini__widget-item">
                  <div class="cartmini__thumb">
                     <a href="shop-details.html">
                        <img src="assets/img/product/small/shop-thumb-1.png.jpeg" alt="">
                     </a>
                  </div>
                  <div class="cartmini__content">
                     <h5 class="cartmini__title"><a href="shop-details.html">Woven Chair</a></h5>
               ...
               <div class="cartmini__widget-item">
                  <div class="cartmini__thumb">
                     <a href="shop-details.html">
                        <img src="assets/img/product/small/shop-thumb-2.png.jpeg" alt="">
                     </a>
                  </div>
                  <div class="cartmini__content">
                     <h5 class="cartmini__title"><a href="shop-details.html">Paxous Chair</a></h5>
                     <div class="cartmini__price-wrapper">
                        <span class="cartmini__price">$120.00</span>
                        <span class="cartmini__quantity">x2</span>
                     </div>
               ...
               <div class="cartmini__widget-item">
                  <div class="cartmini__thumb">
                     <a href="shop-details.html">
                        <img src="assets/img/product/small/shop-thumb-3.png.jpeg" alt="">
                     </a>
                  </div>
                  <div class="cartmini__content">
                     <h5 class="cartmini__title"><a href="shop-details.html">Plush White Chair</a></h5>
                     <div class="cartmini__price-wrapper">
                        <span class="cartmini__price">$120.00</span>
                        <span class="cartmini__quantity">x2</span>
                     </div>
         ...
         <div class="cartmini__checkout">
            ...
            <div class="cartmini__checkout-btn">
               <a href="cart.html" class="tp-btn w-100 mb-10 text-center"> View Cart</a>
               <a href="checkout.html" class="tp-btn tp-btn-black-red w-100 text-center"> Checkout</a>
            </div>
         </div>
      </div>
   </div>
            ...
            <div class="row align-items-center">
               ...
               <div class="col-xl-5 col-6">
                  <div class="tp-header-option d-flex align-items-center justify-content-end">
                     ...
                     <button class="tp-header-cart cartmini-open-btn ml-20 p-relative">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path d="M7.19971 16L16.7916 15.2006C19.7929 14.9506 20.4667 14.295 20.7993 11.3018L21.4995 5" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" />
                           <path d="M5 5H22.5997" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" />
                           <path d="M5.00025 22.6C6.21526 22.6 7.20021 21.615 7.20021 20.4C7.20021 19.185 6.21526 18.2 5.00025 18.2C3.78525 18.2 2.80029 19.185 2.80029 20.4C2.80029 21.615 3.78525 22.6 5.00025 22.6Z" stroke="currentColor" stroke-width="1.2" />
                           <path d="M17.0999 22.6C18.3149 22.6 19.2998 21.615 19.2998 20.4C19.2998 19.185 18.3149 18.2 17.0999 18.2C15.8849 18.2 14.8999 19.185 14.8999 20.4C14.8999 21.615 15.8849 22.6 17.0999 22.6Z" stroke="currentColor" stroke-width="1.2" />
                           <path d="M7.19971 20.4H14.8996" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" />
                           <path d="M0.600098 0.599976H1.66268C2.70181 0.599976 3.6076 1.28703 3.85963 2.2664L7.13235 14.9841C7.29774 15.6269 7.1562 16.3077 6.74705 16.8378L5.69535 18.2" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" />
                        </svg>
                        <span>2</span>
                     </button>
                     <div class="tp-header-top-menu-item tp-header-login ml-20 d-none d-xl-block">
                     ...
                     <div class="tp-header-toogle-wrapper d-xl-none ml-20">
   ...
   <main>
      ...
      <div class="tp-breadcrumb-area tp-breadcrumb-ptb tp-breadcrumb-overly bg-position" data-background="assets/img/breadcrumb/bg-10.jpg">
         <div class="container">
            <div class="row">
               <div class="col-12">
                  <div class="tp-breadcrumb-wrap text-center">
                     <h2 class="tp-breadcrumb-title fs-112 text-center mb-10">Shop Details</h2>
      ...
      <div class="tp-product-details-area pre-header pt-120">
         <div class="tp-product-details-top pb-115">
            <div class="container container-1350">
               <div class="row">
                  <div class="col-xl-7 col-lg-6">
                     <div class="tp-product-details-thumb-wrapper tp-tab d-md-flex align-items-center">
                        ...
                        <nav>
                           <div class="nav nav-tab flex-md-column " id="productDetailsNavThumb2" role="tablist">
                              <button class="nav-links active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                                 <img src="assets/img/product/product-1.jpg" alt="">
                              </button>
                              <button class="nav-links" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2" type="button" role="tab" aria-controls="nav-2" aria-selected="false">
                                 <img src="assets/img/product/product-2.jpg" alt="">
                              </button>
                              <button class="nav-links" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3" type="button" role="tab" aria-controls="nav-3" aria-selected="false">
                                 <img src="assets/img/product/product-3.jpg" alt="">
                              </button>
                              <button class="nav-links" id="nav-4-tab" data-bs-toggle="tab" data-bs-target="#nav-4" type="button" role="tab" aria-controls="nav-4" aria-selected="false">
                                 <img src="assets/img/product/product-4.jpg" alt="">
                              </button>
                           </div>
                        </nav>
                  ...
                  <div class="col-xl-5 col-lg-6">
                     <div class="tp-product-details-wrapper">
                        <div class="tp-product-details-category">
                           <span>Backpack, Utility , Travel</span>
                        </div>
                        <h3 class="tp-product-details-title">Minimal Utility Backpack</h3>
                                                   ...
                                                   <div class="tp-product-details-review-list pr-110">
                                                      ...
                                                      <div class="tp-product-details-review-avater d-flex align-items-start">
                                                         <div class="tp-product-details-review-avater-thumb">
                                                               <a href="#">
                                                                  <img src="assets/img/product/details/user-3.jpg" alt="">
                                                               </a>
                                                         </div>
                                                         <div class="tp-product-details-review-avater-content">
                                                               ...
                                                               <h3 class="tp-product-details-review-avater-title">Harun Rashid</h3>
                                                               <span class="tp-product-details-review-avater-meta">06 March, 2025 </span>
                                                      ...
                                                      <div class="tp-product-details-review-avater d-flex align-items-start">
                                                         <div class="tp-product-details-review-avater-thumb">
                                                               <a href="#">
                                                                  <img src="assets/img/product/details/user-4.jpg" alt="">
                                                               </a>
                                                         </div>
                                                         <div class="tp-product-details-review-avater-content">
                                                               <div class="tp-product-details-review-avater-rating d-flex align-items-center">
                                                               ...
                                                               <h3 class="tp-product-details-review-avater-title">Salim Rana</h3>
                                                               <span class="tp-product-details-review-avater-meta">06 March, 2025 </span>
                                                   ...
                                                   <form action="#">
                                                      ...
                                                      <div class="tp-product-details-review-input-wrapper">
                                                         ...
                                                         <div class="tp-product-details-review-input-box">
                                                               ...
                                                               <div class="tp-product-details-review-input">
                                                                  <input name="name" id="name" type="text" placeholder="Md Harun">
                                                               </div>
                                                         </div>
                                                         <div class="tp-product-details-review-input-box">
                                                               <div class="tp-product-details-review-input-title">
                                                               ...
                                                               <div class="tp-product-details-review-input">
                                                                  <input name="email" id="email" type="email" placeholder="turie@mail.com">
                                                               </div>
                                                         </div>
                                                      </div>
      ...
      <div class="tp-product-ptb pt-120 pb-90">
         <div class="container container-1350">
            <div class="row">
               <div class="col-12">
                  <div class="mb-40">
                  ...
                  <div class="tp-product-item mb-50">
                     ...
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">Polarized Sunglasses</a>
                        </h3>
               ...
               <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="tp-product-item mb-50">
                     ...
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">V-Neck Pure Cotton T-shirt</a>
                        </h3>
                        <div class="tp-product-price-wrapper">
                           <span class="tp-product-price">$190.00</span>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="tp-product-item mb-50">
                     <div class="tp-product-thumb mb-15 fix p-relative z-index-1">
                        ...
                        <div class="tp-product-badge">
                           <span class="product-discount on-sale">-20%</span>
                        </div>
                        <!-- product action -->
                        <div class="tp-product-action tp-product-action-blackStyle">
                           <div class="tp-product-action-item d-flex flex-column">
                     ...
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">Ramie Shirt with Pockets</a>
                        </h3>
                        <div class="tp-product-price-wrapper">
               ...
               <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="tp-product-item mb-50">
                     ...
                     <div class="tp-product-content">
                        ...
                        <h3 class="tp-product-title">
                           <a href="shop-details.html">Shoulder Straps Fitted Top</a>
                        </h3>
                        <div class="tp-product-price-wrapper">

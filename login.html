               ...
               <div class="col-xl-6 col-lg-8">
                  <div class="tp-login-wrapper">
                     <div class="tp-login-top text-center mb-30">
                        <h3 class="tp-login-title">Login to Turie.</h3>
                     ...
                     <div class="tp-login-option">
                        <form action="#">
                           ...
                           <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-30">
                              <div class="tp-review-input d-flex align-items-start">
                                 <input class="tp-checkbox" type="checkbox" id="agree">
                                 <label class="tp-agree" for="agree">Remember me</label>
                              </div>
                           ...
                           <div class="tp-contact-form-btn">
                              <button type="submit" class="tp-btn tp-btn-xl w-100 text-center">Log in</button>
                           </div>
                        </form>
                     </div>
                  </div>

...
<body>
   ...
   <main>
            ...
            <div class="row">
               <div class="col-12">
                  <div class="tp-breadcrumb-wrap text-center">
                     <h2 class="tp-breadcrumb-title fs-112 text-center mb-10">Shopping Cart</h2>
      ...
      <!-- cart area start -->
      <div class="tp-cart-area pre-header pb-120 pt-140">
                     ...
                     <table class="table">
                        ...
                        <tbody>
                           <tr>
                              ...
                              <!-- title -->
                              <td class="tp-cart-title"><a href="shop-details.html">Polarized Sunglasses</a></td>
                              <!-- price -->
                              <td class="tp-cart-price"><span>$120.00</span></td>
                              <!-- quantity -->
                           ...
                           <tr>
                              ...
                              <!-- title -->
                              <td class="tp-cart-title"><a href="shop-details.html">Cotton T-shirt</a></td>
                              <!-- price -->
                              <td class="tp-cart-price"><span>$340.00</span></td>
                              <!-- quantity -->
                              <td class="tp-cart-quantity tp-product-details-quantity">
                                    <div class="tp-product-quantity mt-10 mb-10">
                                       <span class="tp-cart-minus">
                           ...
                           <tr>
                              ...
                              <!-- title -->
                              <td class="tp-cart-title"><a href="shop-details.html">Ramie Shirt </a></td>
                              <!-- price -->
                              <td class="tp-cart-price"><span>$420.00</span></td>
                              <!-- quantity -->
                              <td class="tp-cart-quantity tp-product-details-quantity">
                                    <div class="tp-product-quantity mt-10 mb-10">
                                       <span class="tp-cart-minus">
                           ...
                           <tr>
                              ...
                              <!-- title -->
                              <td class="tp-cart-title"><a href="shop-details.html">Fitted Top</a></td>
                              <!-- price -->
               ...
               <div class="col-xl-3 col-lg-4 col-md-6">
                  <div class="tp-cart-checkout-wrapper">
                     <div class="tp-cart-checkout-top d-flex align-items-center justify-content-between">
                        ...
                        <span class="tp-cart-checkout-top-price">$942</span>
                     </div>
                     <div class="tp-cart-checkout-shipping">
                        <h2 class="tp-cart-checkout-shipping-title">Shipping</h2>

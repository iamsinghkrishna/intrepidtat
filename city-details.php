...
<body>
                              ...
                              <li class="has-dropdown active">
                                 ...
                                 <ul class="sub-menu">
                                    ...
                                    <li class="menu-item-has-children active">
                                       ...
                                       <ul class="sub-menu">
                                          <li class="active"><a href="city-details.html">City Details 01</a></li>
   ...
   <main>
      ...
      <div class="tp-breadcrumb-area tp-breadcrumb-ptb-2 tp-breadcrumb-overly bg-position" data-background="assets/img/breadcrumb/bg-5.jpg">
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-12 col-md-8">
                  <div class="tp-breadcrumb-wrap text-center">
                     <div class="tp-breadcrumb-select d-flex justify-content-center">
                        <select class="tp-select">
                           <option>Change destination</option>
                     ...
                     <h2 class="tp-breadcrumb-title fs-112 text-center mb-0">Destination</h2>
                  </div>
               </div>
            </div>
         </div>
      ...
      <!-- tp-category-area-start -->
      <div class="tp-category-area pt-30 pb-50">
         <div class="container container-1350">
            <div class="row gx-25">
               ...
               <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                  <div class="tp-category-item text-center mb-25">
                     <div class="tp-category-icon">
                        <img src="assets/img/category/icon.png" alt="">
                     </div>
                     <h2 class="tp-category-title"><a href="city-details-2.html">Luxury Hotel<br> Stays</a></h2>
                  </div>
               </div>
               <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                  <div class="tp-category-item text-center mb-25">
                     ...
                     <h2 class="tp-category-title"><a href="city-details-2.html">City Sightseeing<br> Tours</a></h2>
                  </div>
               </div>
               <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                  <div class="tp-category-item text-center mb-25">
                     ...
                     <h2 class="tp-category-title"><a href="city-details-2.html">Adventure Tours</a></h2>
                  </div>
               </div>
               <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                  <div class="tp-category-item text-center mb-25">
                     ...
                     <h2 class="tp-category-title"><a href="city-details-2.html">Airport Pickup<br> Service</a></h2>
                  </div>
               </div>
               <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                  <div class="tp-category-item text-center mb-25">
                     ...
                     <h2 class="tp-category-title"><a href="city-details-2.html">Desert Safari</a></h2>
                  </div>
               </div>
               <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                  <div class="tp-category-item text-center mb-25">
                     <div class="tp-category-icon">
                        <img src="assets/img/category/icon-6.png" alt="">
                     </div>
                     <h2 class="tp-category-title"><a href="city-details-2.html">Budget Travel <br> Deals</a></h2>
                  </div>
               </div>
            </div>
         </div>
      </div>
      <!-- tp-category-area-end -->

      <!-- tp-destination-area-start -->
      <div class="tp-destination-area">
         <div class="container container-1350">
            <div class="row gx-25">
               <div class="col-lg-12">
                  <h2 class="tp-tour-details-title fw-600 mb-25">Destination</h2>
               </div>
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/thumb.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">France</a>
                           <a href="city-details-2.html" class="tp-destination-btn">
                              <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M12 5.75H0.750049" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                 <path d="M7.41414 10.75C7.41414 10.75 12.4141 7.06751 12.4141 5.74994C12.4141 4.43236 7.41406 0.75 7.41406 0.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              </svg>
                           </a>
                        </div>
                     </div>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/thumb-2.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">Thailand</a>
                           <a href="city-details-2.html" class="tp-destination-btn">
                              <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M12 5.75H0.750049" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                 <path d="M7.41414 10.75C7.41414 10.75 12.4141 7.06751 12.4141 5.74994C12.4141 4.43236 7.41406 0.75 7.41406 0.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/thumb-3.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">Switzerland</a>
                           <a href="city-details-2.html" class="tp-destination-btn">
                              <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M12 5.75H0.750049" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                 <path d="M7.41414 10.75C7.41414 10.75 12.4141 7.06751 12.4141 5.74994C12.4141 4.43236 7.41406 0.75 7.41406 0.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/thumb-4.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">Indonesia</a>
                           <a href="city-details-2.html" class="tp-destination-btn">
                              <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M12 5.75H0.750049" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                 <path d="M7.41414 10.75C7.41414 10.75 12.4141 7.06751 12.4141 5.74994C12.4141 4.43236 7.41406 0.75 7.41406 0.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/thumb-5.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">Switzerland</a>
                           <a href="city-details-2.html" class="tp-destination-btn">
                              <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/thumb-6.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">Spain</a>
                           <a href="city-details-2.html" class="tp-destination-btn">
                              <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M12 5.75H0.750049" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                 <path d="M7.41414 10.75C7.41414 10.75 12.4141 7.06751 12.4141 5.74994C12.4141 4.43236 7.41406 0.75 7.41406 0.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/thumb-7.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">New Zealand</a>
                           <a href="city-details-2.html" class="tp-destination-btn">
                              <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M12 5.75H0.750049" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                 <path d="M7.41414 10.75C7.41414 10.75 12.4141 7.06751 12.4141 5.74994C12.4141 4.43236 7.41406 0.75 7.41406 0.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/thumb-8.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">Philippines</a>
                           <a href="city-details-2.html" class="tp-destination-btn">
                              <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M12 5.75H0.750049" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                 <path d="M7.41414 10.75C7.41414 10.75 12.4141 7.06751 12.4141 5.74994C12.4141 4.43236 7.41406 0.75 7.41406 0.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/thumb-9.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">Australia</a>
                           <a href="city-details-2.html" class="tp-destination-btn">
                              <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M12 5.75H0.750049" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                 <path d="M7.41414 10.75C7.41414 10.75 12.4141 7.06751 12.4141 5.74994C12.4141 4.43236 7.41406 0.75 7.41406 0.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/thumb-10.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">Thailand</a>
                           <a href="city-details-2.html" class="tp-destination-btn">
                              <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/thumb-11.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">Switzerland</a>
                           <a href="city-details-2.html" class="tp-destination-btn">
                              <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/thumb-12.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">Indonesia</a>
                           <a href="city-details-2.html" class="tp-destination-btn">
                              <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- tp-tour-area-start -->
      <div class="tp-tour-area tp-tour-ptb-2 pt-55 tp-tour-red pb-45">
         <div class="container container-1350">
            <div class="row align-items-center mb-10">
               <div class="col-lg-9">
                  <h3 class="tp-tour-details-title fw-600 mb-25">Top experiences by city : Tokyo</h3>
               </div>
               <div class="col-lg-3">
                  <div class="text-lg-end mb-25">
                     <a href="city-details-2.html" class="tp-btn">Explore Tokyo</a>
                  </div>
               </div>
            </div>
            <div class="row gx-25">
                  ...
                  <div class="tp-tour-item mb-30">
                     <div class="tp-tour-thumb p-relative fix">
                        <a href="tour-details.html" class="image">
                           <img src="assets/img/tour/13.jpg" alt="tour">
                        </a>
                     ...
                     <div class="tp-tour-content">
                        ...
                        <h3 class="tp-tour-title fw-500 mb-10"><a href="tour-details.html">Chiang mai mountain eco adventure tour.</a></h3>
               ...
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="tp-tour-item mb-30">
                     <div class="tp-tour-thumb p-relative fix">
                        <a href="tour-details.html" class="image">
                           <img src="assets/img/tour/14.jpg" alt="tour">
                        </a>
                        <span class="tp-tour-wishlist">
                           <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M7.22804 14.0605C4.97119 12.3232 0.5 8.35152 0.5 4.77741C0.5 2.41506 2.18408 0.5 4.49969 0.5C5.6996 0.5 6.8995 0.91173 8.49938 2.55865C10.0993 0.91173 11.2992 0.5 12.4991 0.5C14.8146 0.5 16.4988 2.41506 16.4988 4.77741C16.4988 8.35152 12.0276 12.3232 9.77072 14.0605C9.01126 14.6451 7.9875 14.6451 7.22804 14.0605Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                     ...
                     <div class="tp-tour-content">
                        ...
                        <h3 class="tp-tour-title fw-500 mb-10"><a href="tour-details.html">Jungle walking tour with an  authentic cultural lunch</a></h3>
                        <div class="tp-tour-info">
                           <span>
                              <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M9.49961 7.04985C9.49961 8.40295 8.40271 9.49985 7.04961 9.49985C5.69651 9.49985 4.59961 8.40295 4.59961 7.04985C4.59961 5.69675 5.69651 4.59985 7.04961 4.59985C8.40271 4.59985 9.49961 5.69675 9.49961 7.04985Z" stroke="currentColor" stroke-width="1.5" />
               ...
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="tp-tour-item mb-30">
                     <div class="tp-tour-thumb p-relative fix">
                        <a href="tour-details.html" class="image">
                           <img src="assets/img/tour/15.jpg" alt="tour">
                        </a>
                        <span class="tp-tour-wishlist">
                           <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M7.22804 14.0605C4.97119 12.3232 0.5 8.35152 0.5 4.77741C0.5 2.41506 2.18408 0.5 4.49969 0.5C5.6996 0.5 6.8995 0.91173 8.49938 2.55865C10.0993 0.91173 11.2992 0.5 12.4991 0.5C14.8146 0.5 16.4988 2.41506 16.4988 4.77741C16.4988 8.35152 12.0276 12.3232 9.77072 14.0605C9.01126 14.6451 7.9875 14.6451 7.22804 14.0605Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                     ...
                     <div class="tp-tour-content">
                        ...
                        <h3 class="tp-tour-title fw-500 mb-10"><a href="tour-details.html">Desert adventure safari with a Sunset dinner package</a></h3>
                        <div class="tp-tour-info">
                           <span>
                              <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M9.49961 7.04985C9.49961 8.40295 8.40271 9.49985 7.04961 9.49985C5.69651 9.49985 4.59961 8.40295 4.59961 7.04985C4.59961 5.69675 5.69651 4.59985 7.04961 4.59985C8.40271 4.59985 9.49961 5.69675 9.49961 7.04985Z" stroke="currentColor" stroke-width="1.5" />
      ...
      <!-- tp-tour-area-start -->
      <div class="tp-tour-area tp-tour-red tp-tour-city-sidebar pb-75">
         <div class="container container-1350">
            <div class="row gx-25">
               <div class="col-lg-12">
                  <h3 class="tp-tour-details-title tp-tour-details-border fw-600 mb-0 pb-30">All things to do in Japan</h3>
               </div>
                  ...
                  <div class="row gx-25">
                     ...
                     <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                        <div class="tp-tour-item mb-30">
                           <div class="tp-tour-thumb p-relative fix">
                              <a href="tour-details.html" class="image">
                                 <img src="assets/img/tour/city/card/card-7.jpg" alt="tour">
                              </a>
                              <span class="tp-tour-wishlist">
                                 <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.22804 14.0605C4.97119 12.3232 0.5 8.35152 0.5 4.77741C0.5 2.41506 2.18408 0.5 4.49969 0.5C5.6996 0.5 6.8995 0.91173 8.49938 2.55865C10.0993 0.91173 11.2992 0.5 12.4991 0.5C14.8146 0.5 16.4988 2.41506 16.4988 4.77741C16.4988 8.35152 12.0276 12.3232 9.77072 14.0605C9.01126 14.6451 7.9875 14.6451 7.22804 14.0605Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                              ...
                              <div class="tp-tour-media-meta">
                                 <a class="popup-image" href="assets/img/tour/city/card/card-7.jpg">
                                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M4.18192 5.2892C4.79234 5.2892 5.28719 4.79436 5.28719 4.18394C5.28719 3.57352 4.79234 3.07867 4.18192 3.07867C3.5715 3.07867 3.07666 3.57352 3.07666 4.18394C3.07666 4.79436 3.5715 5.2892 4.18192 5.2892Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                                       <path d="M0.5 7.49946C0.5 4.19988 0.5 2.5501 1.52504 1.52504C2.5501 0.5 4.19988 0.5 7.49946 0.5C10.799 0.5 12.4488 0.5 13.4739 1.52504C14.4989 2.5501 14.4989 4.19988 14.4989 7.49946C14.4989 10.799 14.4989 12.4488 13.4739 13.4739C12.4488 14.4989 10.799 14.4989 7.49946 14.4989C4.19988 14.4989 2.5501 14.4989 1.52504 13.4739C0.5 12.4488 0.5 10.799 0.5 7.49946Z" stroke="currentColor" />
                                       <path d="M2.34082 14.1311C5.56263 10.2811 9.17437 5.20352 14.4969 8.63598" stroke="currentColor" />
                     ...
                     <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                        <div class="tp-tour-item mb-30">
                           <div class="tp-tour-thumb p-relative fix">
                              <a href="tour-details.html" class="image">
                                 <img src="assets/img/tour/city/card/card-8.jpg" alt="tour">
                              </a>
                              <span class="tp-tour-wishlist">
                                 <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.22804 14.0605C4.97119 12.3232 0.5 8.35152 0.5 4.77741C0.5 2.41506 2.18408 0.5 4.49969 0.5C5.6996 0.5 6.8995 0.91173 8.49938 2.55865C10.0993 0.91173 11.2992 0.5 12.4991 0.5C14.8146 0.5 16.4988 2.41506 16.4988 4.77741C16.4988 8.35152 12.0276 12.3232 9.77072 14.0605C9.01126 14.6451 7.9875 14.6451 7.22804 14.0605Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                              ...
                              <div class="tp-tour-media-meta">
                                 <a class="popup-image" href="assets/img/tour/city/card/card-8.jpg">
                                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M4.18192 5.2892C4.79234 5.2892 5.28719 4.79436 5.28719 4.18394C5.28719 3.57352 4.79234 3.07867 4.18192 3.07867C3.5715 3.07867 3.07666 3.57352 3.07666 4.18394C3.07666 4.79436 3.5715 5.2892 4.18192 5.2892Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                                       <path d="M0.5 7.49946C0.5 4.19988 0.5 2.5501 1.52504 1.52504C2.5501 0.5 4.19988 0.5 7.49946 0.5C10.799 0.5 12.4488 0.5 13.4739 1.52504C14.4989 2.5501 14.4989 4.19988 14.4989 7.49946C14.4989 10.799 14.4989 12.4488 13.4739 13.4739C12.4488 14.4989 10.799 14.4989 7.49946 14.4989C4.19988 14.4989 2.5501 14.4989 1.52504 13.4739C0.5 12.4488 0.5 10.799 0.5 7.49946Z" stroke="currentColor" />
                                       <path d="M2.34082 14.1311C5.56263 10.2811 9.17437 5.20352 14.4969 8.63598" stroke="currentColor" />
                     ...
                     <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                        <div class="tp-tour-item mb-30">
                           <div class="tp-tour-thumb p-relative fix">
                              <a href="tour-details.html" class="image">
                                 <img src="assets/img/tour/city/card/card-9.jpg" alt="tour">
                              </a>
                              <span class="tp-tour-wishlist">
                                 <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.22804 14.0605C4.97119 12.3232 0.5 8.35152 0.5 4.77741C0.5 2.41506 2.18408 0.5 4.49969 0.5C5.6996 0.5 6.8995 0.91173 8.49938 2.55865C10.0993 0.91173 11.2992 0.5 12.4991 0.5C14.8146 0.5 16.4988 2.41506 16.4988 4.77741C16.4988 8.35152 12.0276 12.3232 9.77072 14.0605C9.01126 14.6451 7.9875 14.6451 7.22804 14.0605Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                              ...
                              <div class="tp-tour-media-meta">
                                 <a class="popup-image" href="assets/img/tour/city/card/card-9.jpg">
                                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M4.18192 5.2892C4.79234 5.2892 5.28719 4.79436 5.28719 4.18394C5.28719 3.57352 4.79234 3.07867 4.18192 3.07867C3.5715 3.07867 3.07666 3.57352 3.07666 4.18394C3.07666 4.79436 3.5715 5.2892 4.18192 5.2892Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                                       <path d="M0.5 7.49946C0.5 4.19988 0.5 2.5501 1.52504 1.52504C2.5501 0.5 4.19988 0.5 7.49946 0.5C10.799 0.5 12.4488 0.5 13.4739 1.52504C14.4989 2.5501 14.4989 4.19988 14.4989 7.49946C14.4989 10.799 14.4989 12.4488 13.4739 13.4739C12.4488 14.4989 10.799 14.4989 7.49946 14.4989C4.19988 14.4989 2.5501 14.4989 1.52504 13.4739C0.5 12.4488 0.5 10.799 0.5 7.49946Z" stroke="currentColor" />
                                       <path d="M2.34082 14.1311C5.56263 10.2811 9.17437 5.20352 14.4969 8.63598" stroke="currentColor" />
                     ...
                     <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                        <div class="tp-tour-item mb-30">
                           <div class="tp-tour-thumb p-relative fix">
                              <a href="tour-details.html" class="image">
                                 <img src="assets/img/tour/city/card/card-10.jpg" alt="tour">
                              </a>
                              <span class="tp-tour-wishlist">
                                 <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.22804 14.0605C4.97119 12.3232 0.5 8.35152 0.5 4.77741C0.5 2.41506 2.18408 0.5 4.49969 0.5C5.6996 0.5 6.8995 0.91173 8.49938 2.55865C10.0993 0.91173 11.2992 0.5 12.4991 0.5C14.8146 0.5 16.4988 2.41506 16.4988 4.77741C16.4988 8.35152 12.0276 12.3232 9.77072 14.0605C9.01126 14.6451 7.9875 14.6451 7.22804 14.0605Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                              ...
                              <div class="tp-tour-media-meta">
                                 <a class="popup-image" href="assets/img/tour/city/card/card-10.jpg">
                                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M4.18192 5.2892C4.79234 5.2892 5.28719 4.79436 5.28719 4.18394C5.28719 3.57352 4.79234 3.07867 4.18192 3.07867C3.5715 3.07867 3.07666 3.57352 3.07666 4.18394C3.07666 4.79436 3.5715 5.2892 4.18192 5.2892Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                                       <path d="M0.5 7.49946C0.5 4.19988 0.5 2.5501 1.52504 1.52504C2.5501 0.5 4.19988 0.5 7.49946 0.5C10.799 0.5 12.4488 0.5 13.4739 1.52504C14.4989 2.5501 14.4989 4.19988 14.4989 7.49946C14.4989 10.799 14.4989 12.4488 13.4739 13.4739C12.4488 14.4989 10.799 14.4989 7.49946 14.4989C4.19988 14.4989 2.5501 14.4989 1.52504 13.4739C0.5 12.4488 0.5 10.799 0.5 7.49946Z" stroke="currentColor" />
                                       <path d="M2.34082 14.1311C5.56263 10.2811 9.17437 5.20352 14.4969 8.63598" stroke="currentColor" />
                     ...
                     <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                        <div class="tp-tour-item mb-30">
                           <div class="tp-tour-thumb p-relative fix">
                              <a href="tour-details.html" class="image">
                                 <img src="assets/img/tour/city/card/card-11.jpg" alt="tour">
                              </a>
                              <span class="tp-tour-wishlist">
                                 <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.22804 14.0605C4.97119 12.3232 0.5 8.35152 0.5 4.77741C0.5 2.41506 2.18408 0.5 4.49969 0.5C5.6996 0.5 6.8995 0.91173 8.49938 2.55865C10.0993 0.91173 11.2992 0.5 12.4991 0.5C14.8146 0.5 16.4988 2.41506 16.4988 4.77741C16.4988 8.35152 12.0276 12.3232 9.77072 14.0605C9.01126 14.6451 7.9875 14.6451 7.22804 14.0605Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                              ...
                              <div class="tp-tour-media-meta">
                                 <a class="popup-image" href="assets/img/tour/city/card/card-11.jpg">
                                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M4.18192 5.2892C4.79234 5.2892 5.28719 4.79436 5.28719 4.18394C5.28719 3.57352 4.79234 3.07867 4.18192 3.07867C3.5715 3.07867 3.07666 3.57352 3.07666 4.18394C3.07666 4.79436 3.5715 5.2892 4.18192 5.2892Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                                       <path d="M0.5 7.49946C0.5 4.19988 0.5 2.5501 1.52504 1.52504C2.5501 0.5 4.19988 0.5 7.49946 0.5C10.799 0.5 12.4488 0.5 13.4739 1.52504C14.4989 2.5501 14.4989 4.19988 14.4989 7.49946C14.4989 10.799 14.4989 12.4488 13.4739 13.4739C12.4488 14.4989 10.799 14.4989 7.49946 14.4989C4.19988 14.4989 2.5501 14.4989 1.52504 13.4739C0.5 12.4488 0.5 10.799 0.5 7.49946Z" stroke="currentColor" />
                                       <path d="M2.34082 14.1311C5.56263 10.2811 9.17437 5.20352 14.4969 8.63598" stroke="currentColor" />
                     ...
                     <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                        <div class="tp-tour-item mb-30">
                           <div class="tp-tour-thumb p-relative fix">
                              <a href="tour-details.html" class="image">
                                 <img src="assets/img/tour/city/card/card-12.jpg" alt="tour">
                              </a>
                              <span class="tp-tour-wishlist">
                                 <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.22804 14.0605C4.97119 12.3232 0.5 8.35152 0.5 4.77741C0.5 2.41506 2.18408 0.5 4.49969 0.5C5.6996 0.5 6.8995 0.91173 8.49938 2.55865C10.0993 0.91173 11.2992 0.5 12.4991 0.5C14.8146 0.5 16.4988 2.41506 16.4988 4.77741C16.4988 8.35152 12.0276 12.3232 9.77072 14.0605C9.01126 14.6451 7.9875 14.6451 7.22804 14.0605Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                              ...
                              <div class="tp-tour-media-meta">
                                 <a class="popup-image" href="assets/img/tour/city/card/card-12.jpg">
                                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M4.18192 5.2892C4.79234 5.2892 5.28719 4.79436 5.28719 4.18394C5.28719 3.57352 4.79234 3.07867 4.18192 3.07867C3.5715 3.07867 3.07666 3.57352 3.07666 4.18394C3.07666 4.79436 3.5715 5.2892 4.18192 5.2892Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                                       <path d="M0.5 7.49946C0.5 4.19988 0.5 2.5501 1.52504 1.52504C2.5501 0.5 4.19988 0.5 7.49946 0.5C10.799 0.5 12.4488 0.5 13.4739 1.52504C14.4989 2.5501 14.4989 4.19988 14.4989 7.49946C14.4989 10.799 14.4989 12.4488 13.4739 13.4739C12.4488 14.4989 10.799 14.4989 7.49946 14.4989C4.19988 14.4989 2.5501 14.4989 1.52504 13.4739C0.5 12.4488 0.5 10.799 0.5 7.49946Z" stroke="currentColor" />
                                       <path d="M2.34082 14.1311C5.56263 10.2811 9.17437 5.20352 14.4969 8.63598" stroke="currentColor" />
      ...
      <!-- tp-tour-tips-area-start -->
      <div class="tp-tour-tips-area tp-tour-tips-spacing pb-135">
         <div class="container container-1350">
            <div class="row">
               <div class="col-lg-12">
                  <h3 class="tp-tour-details-title fw-600 mb-25">Travel Tips</h3>
               </div>
            </div>
            <div class="tp-tour-tips-wrap">
               <div class="row">
                  <div class="col-lg-7">
                     <div class="tp-tour-tips-content mr-30 mb-30">
                        <h3 class="tp-tour-tips-title fw-500 mb-15">About Japan</h3>
                        <p class="mb-35">Japan, the Land of the Rising Sun, is a perfect blend of ancient tradition and modern innovation.
                           From the bustling streets of Tokyo to the peaceful temples of Kyoto, every corner of Japan offers story
                           to tell. This island nation is home to breathtaking natural beauty, snow-capped mountains, and world
                           famous cherry blossoms that color the country every spring.</p>
                        <p class="mb-40">Visitors can explore vibrant city life, taste authentic sushi, witness sumo wrestling, or soak in a natural
                           hot spring under the stars. With its warm hospitality, clean cities, and efficient transport system, Japan
                           ensures a travel experience that’s both exciting and peaceful. Whether you’re chasing adventure,culture, or serenity — Japan welcomes you with open arms and endless discovery.</p>
                        <h3 class="tp-tour-tips-title fw-500 mb-20">General info</h3>
                        <div class="row">
                           <div class="col-xl-9">
                              <div class="tp-tour-tips-list">
                                 <div>
                                    <span>Currency</span>
                                    <span class="text-black">Vietnamese dong</span>
                                    <span>1NZD=10.030.12VND</span>
                                 </div>
                                 <div>
                                    <span>Language (S)</span>
                                    <span class="text-black">Japanese</span>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="col-lg-5">
                     <div class="tp-tour-tips-map-wrap ml-40 mb-30">
                        <p>Our Cafe in Samsøgade 17, 9000 Aalborg.</p>
                        <div class="tp-tour-tips-map">
      ...
      <!-- tp-tour-tips-area-end -->

      <!-- tp-destination-area-start -->
      <div class="tp-destination-area tp-destination-nearby-wrap pb-115">
         <div class="container container-1350">
            <div class="row gx-25">
               <div class="col-lg-12">
                  <h2 class="tp-tour-details-title fw-600 mb-25">Nearby destinations</h2>
               </div>
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/nearby/thumb.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">Philippines</a>
                        </div>
                     </div>
               ...
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/nearby/thumb-2.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">Hong Kong</a>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/nearby/thumb-3.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">South Korea</a>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="tp-tour-dayfilter-item tp-destination-item fix mb-25">
                     <div class="tp-destination-thumb p-relative tp-tour-dayfilter-thumb fix">
                        <img src="assets/img/destination/nearby/thumb-4.jpg" alt="destination">
                        <div class="tp-destination-content">
                           <a href="city-details-2.html" class="tp-destination-title common-underline">Mongolia</a>
                        </div>
                     </div>
                  </div>
               </div>

...
<body>
                        ...
                        <nav class="tp-mobile-menu-active">
                           <ul>
                              ...
                              <li class="has-dropdown active">
                                 ...
                                 <ul class="sub-menu">
                                    <li class="active"><a href="tour-grid.html">Tour Grid</a></li>
   ...
   <main>
      ...
      <div class="tp-breadcrumb-area tp-breadcrumb-ptb tp-breadcrumb-overly bg-position" data-background="assets/img/breadcrumb/bg.jpg">
         <div class="container">
         ...
         <div class="container">
            <div class="tp-tour-filter-wrap">
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="tp-tour-sort mb-25 d-flex justify-content-md-end">
